...
def main():
    ...
    parser.add_argument('--graph_pooling', type=str, default="logical",
...
#    print(logical_params[0][1])
    ...
    # print('Test score: {}'.format(test_curve[best_val_epoch]))
        ...
        torch.save({'Val': valid_perf, 'Test': test_perf, 'Train': train_perf, 'BestTrain': train_perf}, "./final_experiments_v5/"+args.filename+"_"+str(args.num_layer_gnn)+"_"+str(epoch)+"_"+str(args.emb_dim)+"_"+args.graph_pooling+"_"+args.gnn+"-"+str(round(valid_perf,4))+"-"+str(round(test_perf,4)))
        torch.save(model.state_dict(),"./final_experimets_v5_molbba_models/"+args.filename+"_"+str(args.num_layer_gnn)+"_"+str(epoch)+"_"+str(args.emb_dim)+"_"+args.graph_pooling+"_"+args.gnn+"-"+str(round(valid_perf,4))+"-"+str(round(test_perf,4)))
